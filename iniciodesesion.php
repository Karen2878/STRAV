...
<body>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <!-- Formulario -->
            <form method="POST" action="../BackEnd/iniciarsesion.php" onsubmit="return validarFormulario()">
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button id="btnSubmit" type="submit" class="btn btn-custom">Iniciar Sesión</button>
                </div>
            </form>
